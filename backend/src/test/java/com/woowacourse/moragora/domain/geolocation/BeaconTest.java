...
class BeaconTest {
    ...
    @Test
    void calculateDistance_inLatitudeSize1Degree() {
        // given
    ...
    @Test
    void calculateDistance_inLongitudeSize1Degree() {
        // given
    ...
    @Test
    void calculateDistance_inLongitudeSize1Degree_atNorthernHemisphere() {
        // given
    ...
    @Test
    void calculateDistance__inLatitudeLongitudeSize1Degree() {
        // given
        ...
        final double distanceOnPlain = sqrt(2) * equatorDistance;
    ...
    @DisplayName("대한민국의 북위 37도에서 경도 사이의 1도는 88.1km에 근접한다")
    @Test
    void calculateDistance__inLongitudeSize1Degree_atKorea() {
        // given
